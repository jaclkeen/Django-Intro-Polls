# Django automatically looks for a tests.py file to run tests
# to run the any modules tests run python manage.py test ModuleName
...
def create_question(question_text, days):
    """Creates a question with the given `question_text` published the given number of `days` offset to now (negative for questions published
